$(document).ready(function () {
    ...
    const imageMap = {
        '1A': ['./assets/images/catalogue/1A/preview (1).jpg', './assets/images/catalogue/1A/preview (2).jpg'],
        '3A': ['./assets/images/catalogue/3A/preview (1).jpg', './assets/images/catalogue/3A/preview (2).jpg'],
        '1B': ['./assets/images/catalogue/1B/preview (1).jpg', './assets/images/catalogue/1B/preview (2).jpg'],
        'V1': ['./assets/images/catalogue/V1/preview (1).jpg', './assets/images/catalogue/V1/preview (2).jpg'],
        'V2': ['./assets/images/catalogue/V2/preview (1).jpg', './assets/images/catalogue/V2/preview (2).jpg'],
        'V3': ['./assets/images/catalogue/V3/preview (1).jpg', './assets/images/catalogue/V3/preview (2).jpg']
    };
    ...
    function renderUnits(properties) {
        ...
        properties.forEach(property => {
            ...
            const unitHtml = `
                <div class="col-6">
                    <a href="./view-unit.html?unit=${property['Unit Code']}&level=${level}&floor=${property['Floor Number']}" class="s-color d-flex flex-column align-items-center rounded-4 mt-5 mb-3 p-3">
